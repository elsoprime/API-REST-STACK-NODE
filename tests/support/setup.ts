...
process.env.AUTH_VERIFY_EMAIL_URL ??= 'http://localhost:5173/auth/verify-email';
process.env.AUTH_RESET_PASSWORD_URL ??= 'http://localhost:5173/auth/reset-password';
process.env.TENANT_INVITATION_ACCEPT_URL ??= 'http://localhost:5173/tenant/invitations/accept';
process.env.EMAIL_MAILPIT_SMTP_HOST ??= '127.0.0.1';
process.env.EMAIL_MAILPIT_SMTP_PORT ??= '1025';
process.env.EMAIL_RESEND_API_BASE_URL ??= 'https://api.resend.com';
process.env.EMAIL_DELIVERY_TIMEOUT_MS ??= '5000';
